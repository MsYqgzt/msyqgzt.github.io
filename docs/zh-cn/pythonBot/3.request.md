...
### 4. 爬取肯德基餐厅查询http://www.kfc.com.cn/kfccda/index.aspx 中指定地点的餐厅数

> 根据`Content-Type: text/plain; charset=utf-8`这一属性，返回的结果为text，因此无需调用json
> 
> 同样指定url为请求包内的链接，获取`Form Data`内的参数作为请求的参数
...
### 5. 【进阶】爬取国家药品监督管理总局中 基于中华人民共和国化妆品生产许可证相关数据http://125.35.6.84:81/xk
