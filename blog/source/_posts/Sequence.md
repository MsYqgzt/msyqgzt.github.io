...
{% asset_img Bubble Sort.gif Bubble Sort %}
...
{% asset_img Selection Sort.gif Selection Sort %}
...
{% asset_img Insertion Sort.gif Insertion Sort %}
...
{% asset_img Merge Sort.gif Merge Sort %}
...
{% asset_img Quick Sort.gif Quick Sort %}
...
{% asset_img Heap Sort.gif Heap Sort %}
...
{% asset_img Counting Sort.gif Counting Sort %}
...
{% asset_img Bucket Sort.png Bucket Sort %}
...
{% asset_img Radix Sort.gif Radix Sort %}
